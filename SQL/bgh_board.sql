...
VALUES('bgh3508@naver.com', 'P!ssw0rd', 'jiraynor', '010-1111-2222', '부산광역시', '부산진구', true);

-- 로그인
-- 패스워드 암호화가 되어있지 않을 때 
SELECT * FROM USER
WHERE email = 'bgh3508@naver.com'
...
VALUES ('Test Title', 'Test Content', null, now(), 'bgh3508@naver.com');
...
-- 내게시물 리스트
SELECT * FROM Board_View
WHERE writer_email = 'bgh3508@naver.com';

-- 좋아요 
INSERT INTO Liky (user_email, board_number)
VALUES ('bgh3508@naver.com', 1);

-- 좋아요 취소
DELETE FROM Liky
WHERE user_email = 'bgh3508@naver.com'
AND board_number = 1;

-- 댓글 작성
INSERT INTO Comment (user_email, board_number, comment_content, write_datetime)
VALUES ('bgh3508@naver.com', 1, 'Test Comment', now());

-- 게시물 수정
UPDATE
	Board
SET 
	title = 'Modified Title', content = 'Modified Content', board_image_url = 'http://!!'
WHERE 
	board_number = 1;
