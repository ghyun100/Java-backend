...
// 게시물
//
//게시물번호(정수) / 이미지(문자열(url)) / 작성자 이메일(문자열)
// 작성자 닉네임(문자열) / 작성자 프로필사진(문자열(url)) /
// 작성일(문자열) / 제목(문자열) / 내용(문자열) / 조회수(정수) / 
// 댓글 수(정수)-리스트사이즈(변수추가X)  / 좋아요 수(정수)-리스트사이즈(변수추가X) /
// 좋아요(좋아요한 사용자 이메일, 좋아요한 사용자프로필사진, 좋아요한 사용자 닉네임) 리스트
// 댓글(댓글작성자 프로필사진, 댓글 작성자 닉네임, 댓글 작성 지난 시간, 댓글내용) 리스트
public class Board {
