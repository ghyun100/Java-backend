...
public class ReservationService {
	private static List<Train> trains = new ArrayList<>(); // 기차두대
	...
	public ReservationInfo postReservation(PostReservationDto postReservationDto, GetTrainListDto getTrainListDto) {// 반환타입을
																													// ReservationInfo로
																													// 하겠다는
																													// 것
		// ReservationInfo 라는 클래스를 만들어서 import가 가능
		...
		for (Cost cost : costs) {
			...
			boolean isEqualDepartureStation = getTrainListDto.isEqualDepartureStation(cost.getDepratureStation());
	...
	public ReservationInfo getReservation(GetReservationDto dto) {
		...
		ReservationInfo reservationInfo = null; // 예약정보를 저장할 변수
